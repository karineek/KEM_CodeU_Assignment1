...
public class main {
    ...
    public static void main(String[] args) {
        ...
        SinglyLinkedList<String> data_list = 
                                new SinglyLinkedList<>(Arrays.asList(list_user));
        
        /* Q2: Run and result */
        String res = q2_getKthElement(data_list, k2last); 
        /* Incase of error will throw exception before print*/
    ...
    */
    ...
    static void run_test_Q2(String str_list, int k2last)
    {
        ...
        /* Q2: Run and result */
        String res = q2_getKthElement(my_list, k2last); 
        /* Incase of error will throw exception before print */
